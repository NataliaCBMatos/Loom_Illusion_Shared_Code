...
allGens = {out_spEmptyShts,out_LC16_IsoD1,out_LC16_Shts,...
    out_LC12_IsoD1,out_LC12_Shts,...
    out_LC17_IsoD1,out_LC17_Shts};
...
barPlotMultGen(name,AllGen_MeansStim,AllGen_ErrorsStim,DataPoints(2:end),cell2mat(DataPoints(1)),cond,beh,figLeg,0.7,0)
idx = idx +1;
end
